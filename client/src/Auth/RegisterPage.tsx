...
export interface RegisterState {
    ...
    error: {
        value: string;
        fieldName: "" | "email" | "password" | "confirmedPassword";
    };
}
                    ...
                    <HeroLeftContainer>
                        <HeroLeftWrapper>
                            ...
                            <AuthFormContainer>
                                <FormContainer>
                                    <FormError
                                        isError={validation.error.value !== ""}
                                    >
                                    ...
                                    <FormInputsContainer>
                                        <TextInput
                                            ...
                                            scheme={getValidationScheme(
                                                validation.error.fieldName,
                                                registerState.email.fieldName
                                            )}
                                            Icon={<MailIcon />}
                                        />
                                        <TextInput
                                            ...
                                            scheme={getValidationScheme(
                                                validation.error.fieldName,
                                                registerState.password.fieldName
                                            )}
                                            Icon={<LockIcon />}
                                        />
                                        <TextInput
                                            ...
                                            scheme={getValidationScheme(
                                                validation.error.fieldName,
                                                registerState.confirmedPassword
                                                    .fieldName
                                            )}
                                            Icon={<LockIcon />}
                                        />
